<template>
  <a href="https://www.linkedin.com/in/wojciech-sku%C5%82a/" target="_blank" class=" hover:text-[#76ABAE] transition duration-500 ease-in-out ">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 50 50" width="44px" height="44px" fill="currentColor">
